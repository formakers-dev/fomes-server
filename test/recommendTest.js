...
describe('Recommend', () => {
   describe('GET /recommend/similar/demographic', () => {
    ...
    describe('GET /recommend/favorite/category', () => {
        before(done => {
            Users.create(config.testUser)
                .then(() => AppUsages.create([
                    ////////// start of me ///////////////
        ...
        it('최애 장르의 게임들을 전체 게이머들의 사용시간으로 정렬한 리스트를 반환한다', done => {
            request.get('/recommend/favorite/category/GAME')
                .set('x-access-token', config.appbeeToken.valid)
                .expect(200)
                .then((res) => {
                    ...
                    res.body[1].app.packageName.should.be.eql('com.game.edu2');
                    res.body[1].app.appName.should.be.eql('교육게임명2');
                    ...
                    res.body[1].app.totalUsedTime.should.be.eql(12000);
